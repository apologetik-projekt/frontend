			...
			<div className="xl:px-40 pb-12 px-2  max-w-5xl mx-auto">
				<div className="w-full pt-12 flex flex-col sm:flex-row justify-between">
					<div className="w-full sm:w-2/5 pr-6 flex flex-col space-y-4">
						...
						<p className="opacity-60">Christen zurüsten, Zweiflern begegnen, Skeptikern antworten.</p>
					</div>
					...
					<div className="w-full sm:w-3/5 flex flex-col sm:items-end mt-4 sm:mt-0 mr-1">
						...
						<div className="w-full sm:w-1/5 pt-4 flex items-end">
							<div className="flex flex-row space-x-4">
								<a target="_blank" href="https://instagram.com/derapologetikchannel"><svg className="opacity-70 hover:opacity-90" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M16.98 0a6.9 6.9 0 0 1 5.08 1.98A6.94 6.94 0 0 1 24 7.02v9.96c0 2.08-.68 3.87-1.98 5.13A7.14 7.14 0 0 1 16.94 24H7.06a7.06 7.06 0 0 1-5.03-1.89A6.96 6.96 0 0 1 0 16.94V7.02C0 2.8 2.8 0 7.02 0h9.96zm.05 2.23H7.06c-1.45 0-2.7.43-3.53 1.25a4.82 4.82 0 0 0-1.3 3.54v9.92c0 1.5.43 2.7 1.3 3.58a5 5 0 0 0 3.53 1.25h9.88a5 5 0 0 0 3.53-1.25 4.73 4.73 0 0 0 1.4-3.54V7.02a5 5 0 0 0-1.3-3.49 4.82 4.82 0 0 0-3.54-1.3zM12 5.76c3.39 0 6.2 2.8 6.2 6.2a6.2 6.2 0 0 1-12.4 0 6.2 6.2 0 0 1 6.2-6.2zm0 2.22a3.99 3.99 0 0 0-3.97 3.97A3.99 3.99 0 0 0 12 15.92a3.99 3.99 0 0 0 3.97-3.97A3.99 3.99 0 0 0 12 7.98zm6.44-3.77a1.4 1.4 0 1 1 0 2.8 1.4 1.4 0 0 1 0-2.8z"/></svg></a>
								<a target="_blank" href="https://youtube.com/c/derapologetikchannel"><svg className="opacity-70 hover:opacity-90" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12.04 3.5c.59 0 7.54.02 9.34.5a3.02 3.02 0 0 1 2.12 2.15C24 8.05 24 12 24 12v.04c0 .43-.03 4.03-.5 5.8A3.02 3.02 0 0 1 21.38 20c-1.76.48-8.45.5-9.3.51h-.17c-.85 0-7.54-.03-9.29-.5A3.02 3.02 0 0 1 .5 17.84c-.42-1.61-.49-4.7-.5-5.6v-.5c.01-.9.08-3.99.5-5.6a3.02 3.02 0 0 1 2.12-2.14c1.8-.49 8.75-.51 9.34-.51zM9.54 8.4v7.18L15.82 12 9.54 8.41z"/></svg></a>
								<a target="_blank" href="https://tiktok.com/@apologetikchannel">
									<svg className="opacity-70 hover:opacity-95" height="20" width="20" viewBox="0 0 170 170" xmlns="http://www.w3.org/2000/svg">
										<g clip-rule="evenodd" fill-rule="even-odd">
